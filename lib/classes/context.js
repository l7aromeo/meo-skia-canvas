...
class CanvasRenderingContext2D extends RustClass {
  ...
  getImageData(
    ...
    // reproduced in JavaScript, and it would still disagree with the export
    // path about the size of the same region. One rule for both belongs in the
    // addon; until then this takes only the values where the two cannot
    // differ.
    //
