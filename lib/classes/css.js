...
var plainFilterRE =
  ...
  percentValueRE = /^(\+|-)?\d+%$/,
  // The sign is part of the number: without it `hue-rotate(-45deg)` parsed
  // as +45 and rotated the wrong way. An exponent is valid CSS too.
  angleValueRE = /([+-]?[\d.]+(?:e[+-]?\d+)?)(deg|g?rad|turn)/i;
