...
class CanvasGradient extends RustClass {
  ...
  //
  // Neither older name is deprecated and neither is going away. The gain
  // is precision, not a correction, and that does not justify making a
  // caller rewrite working code. The names an eventual standard settles
  // on are still open -- whatwg/html issues 7947 and 8296 propose two
  // different spellings for the colour one -- which is the other reason
  // not to deprecate anything yet.
  //
