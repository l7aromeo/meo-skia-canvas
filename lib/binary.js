...
// it:
//
//   MEO_SKIA_CANVAS_BINARY="$PWD/lib/skia.node" node --test
//
// `npm test` and `just test` set it for you -- scripts/test.mjs and the `test-js` recipe
// respectively -- so this is for a direct `node` invocation.
//
