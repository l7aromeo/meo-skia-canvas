...
Everything below predates the separation, with both channels interleaved and
each entry headed by the versions it carried. It has not been divided
retrospectively: the two histories are 113 npm tags and 22 crate tags deep,
and assigning a channel per entry after the fact would mean deciding from
